...
@section('content')
<p class="lead">Please enter your details: or register with <a href="{{ url('account/social-login/facebook') }}">Facebook</a>, <a href="{{ url('account/social-login/twitter') }}">Twiter</a> or <a href="{{ url('account/social-login/google') }}"">Google+</a></p>
<div class="well">
